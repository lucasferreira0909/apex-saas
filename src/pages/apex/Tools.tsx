...
import { Calculator, MessageSquare, Hash, MessageSquareQuote, Image, ShoppingBag, FileText, Type, Tag } from "lucide-react";
...
const tools: Tool[] = [
  ...
  },
  {
    ...
    features: ["3 variações de copy", "Múltiplos tons", "Geração por IA"]
  },
  {
    ...
    features: ["Instagram, TikTok, YouTube", "8 headlines por geração", "Dicas de uso"]
  },
  {
    id: "offer-generator",

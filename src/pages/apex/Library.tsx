...
import { Plus, Search, Filter, Folder, Workflow, MoreHorizontal, Edit, Trash2, X } from "lucide-react";
  ...
  return <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        <div className="relative flex-1 max-w-md">
          ...
          <Input placeholder="Buscar projetos..." className="pl-10 bg-input border-border" value={searchTerm} onChange={e => {
      ...
      <Card className="bg-card border-border">
        <CardHeader>
          <CardTitle className="text-card-foreground">Funis ({filteredProjects.length})</CardTitle>
